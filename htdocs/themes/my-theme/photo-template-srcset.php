...
<link href="https://fonts.googleapis.com/css?family=Armata|Changa" rel="stylesheet">
<!--
*****************
...
<!-- content="FirstName LastName" -->
 ...
 <body>
  ...
  <header>
    <p class="headerTitle">Your Name Design</p>
    <p class="headerSubtitle">Photography Portfolio</p>
</header>
...
<img srcset="/img/<?php echo $filename . "_400px.jpg" ?> 400w,
             /img/<?php echo $filename . "_600px.jpg" ?> 600w,
             /img/<?php echo $filename . "_800px.jpg" ?> 800w,
		  /img/<?php echo $filename . "_1200px.jpg" ?> 1200w"

             sizes="(max-width: 320px) 400px,
                    (max-width: 640px) 600px,
                    (max-width: 1024px) 800px,
                    1200px"
     src="/img/<?php echo $filename . "_800px.jpg" ?>"
...
<nav class="pagination">
  <a href="<?php echo $previous ?>" class="previous">Previous</a>
  <a href="<?php echo $next ?>" class="next">Next</a>
</nav>
